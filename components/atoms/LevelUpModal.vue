<template>
	<!-- uma uma função que podemos usar pra adicionar transição a mudança de componetes -->
	<transition name="slide-fade">
		...
		>
			<!-- stop propragretion ivita de cicajk fora de onde eu quero -->
			<div
...
<script lang="ts">
import Vue from "vue";
// importar o level que vem da mutations
...
// scoped apenas para esse componente
<style scoped>
.overlay {
